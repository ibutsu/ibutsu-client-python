...
class CreateToken(BaseModel):
    ...
    expires: StrictStr | None = Field(description="The date and time when this token expires")
    __properties: ClassVar[list[str]] = ["name", "expires"]
    ...
    def from_dict(cls, obj: dict[str, Any] | None) -> Self | None:
        ...
        _obj = cls.model_validate({"name": obj.get("name"), "expires": obj.get("expires")})
        return _obj
