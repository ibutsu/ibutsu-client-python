...
class WidgetParam(BaseModel):
    ...
    name: StrictStr | None = Field(
        default=None, description="The name of the parameter to supply to the widget"
    )
    description: StrictStr | None = Field(
        default=None, description="A friendly description of the parameter"
    )
    type: StrictStr | None = Field(
        default=None, description="The type of parameter (string, integer, etc)"
    )
