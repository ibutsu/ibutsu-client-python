...
class GetReportTypes200ResponseInner(BaseModel):
    """
    GetReportTypes200ResponseInner
    """

    type: StrictStr | None = Field(
        default=None, description="The machine-readable name of report type"
    )
    name: StrictStr | None = Field(
        default=None, description="The human-readable name of report type"
    )
