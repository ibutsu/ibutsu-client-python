...
from ibutsu_client import rest
from ibutsu_client.configuration import Configuration
from ibutsu_client.exceptions import ApiTypeError, ApiValueError, ApiException
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = AdminProjectManagementApi()
        api_instance.admin_add_project  # this is an instance of the class Endpoint
        api_instance.admin_add_project()  # this invokes api_instance.admin_add_project.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.admin_add_project.callable or self.callable in this class
