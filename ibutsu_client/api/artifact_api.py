...
from ibutsu_client.model_utils import (
    date,
    datetime,
    file_type,
    none_type,
...
class ArtifactApi:
    ...
    def delete_artifact(self, id, **kwargs):
        """Delete an artifact
    ...
    def download_artifact(self, id, **kwargs):
    ...
    def get_artifact(self, id, **kwargs):
    ...
    def get_artifact_list(self, **kwargs):
    ...
    def upload_artifact(self, filename, file, **kwargs):
    ...
    def view_artifact(self, id, **kwargs):
