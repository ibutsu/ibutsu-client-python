...
class ReportApi:
    ...
    def __init__(self, api_client=None):
        ...
        self.get_report_types_endpoint = _Endpoint(
            settings={
                "response_type": ([GetReportTypes200ResponseInner],),
                "auth": ["jwt"],
    ...
    def add_report(self, report_parameters, **kwargs):
        """Create a new report
        ...
        kwargs["report_parameters"] = report_parameters
        return self.add_report_endpoint.call_with_http_info(**kwargs)

    def delete_report(self, id, **kwargs):
        """Delete a report
    ...
    def get_report_types(self, **kwargs):
    ...
    def view_report(self, id, filename, **kwargs):
        """View a report
