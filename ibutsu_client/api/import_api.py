...
class ImportApi:
    ...
    def add_import(self, import_file, **kwargs):
        ...
        kwargs["import_file"] = import_file
        return self.add_import_endpoint.call_with_http_info(**kwargs)

    def get_import(self, id, **kwargs):
