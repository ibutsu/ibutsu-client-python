...
class WidgetConfigApi:
    ...
    def add_widget_config(self, **kwargs):
    ...
    def delete_widget_config(self, id, **kwargs):
    ...
    def get_widget_config(self, id, **kwargs):
    ...
    def get_widget_config_list(self, **kwargs):
    ...
    def update_widget_config(self, id, **kwargs):
