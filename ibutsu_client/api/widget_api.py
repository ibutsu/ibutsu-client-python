...
class WidgetApi:
    ...
    def get_widget(
        self,
        id: Annotated[UUID, Field(description="The widget identifier")],
        params: Annotated[
            dict[str, Any] | None, Field(description="The parameters for the widget")
        ] = None,
        ...
        :param id: The widget identifier (required)
        :type id: str
    ...
    def get_widget_types(
        self,
        type: Annotated[StrictStr | None, Field(description="Filter by type of widget")] = None,
        _request_timeout: None
        | Annotated[StrictFloat, Field(gt=0)]
        | tuple[Annotated[StrictFloat, Field(gt=0)], Annotated[StrictFloat, Field(gt=0)]] = None,
        _request_auth: dict[StrictStr, Any] | None = None,
        ...
        :param type: Filter by type of widget
        :type type: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
