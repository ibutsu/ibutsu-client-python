...
class User(ModelNormal):
    ...
    attribute_map = {
        ...
        'id': 'id',  # noqa: E501
        'name': 'name',  # noqa: E501
        'is_superadmin': 'is_superadmin',  # noqa: E501
    ...
    def _from_openapi_data(cls, email, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            is_superadmin (bool): Flag to show if a user is a super-admin. [optional]  # noqa: E501
            is_active (bool): Flag to show if the user is active. [optional]  # noqa: E501
            group_id (str, none_type): The ID of the group of this project. [optional]  # noqa: E501
        """
