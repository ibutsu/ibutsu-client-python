...
class Token(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, user_id, name, token, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            expires (str, none_type): The date and time when this token expires. [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, user_id, name, token, *args, **kwargs):  # noqa: E501
        """Token - a model defined in OpenAPI
