...
from ibutsu_client.models.group_list import GroupList  # noqa: E501
...
class TestGroupList(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = ibutsu_client.models.group_list.GroupList()  # noqa: E501
        if include_optional :
            return GroupList(
                groups = [
                    {"id":"af3b3ff0c6188c9ba767","name":"Example group"}
                    ], 
